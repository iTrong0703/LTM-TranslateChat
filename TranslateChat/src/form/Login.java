...
public class Login extends javax.swing.JPanel {
    ...
    private void init() {
        PublicEvent.getInstance().addEventLogin(new IEventLogin() {
            @Override
                        ...
                        Service.getInstance().getClient().emit("login", data.toJsonObject(), new Ack() {
                            ...
                            public void call(Object... os) {
                                if(os.length > 0) {
                                    ...
                                    if(action) {
//                                        JSONObject response = (JSONObject) os[1];
                ...
                Service.getInstance().getClient().emit("register", data.toJsonObject(), new Ack() {
                    ...
                    public void call(Object... os) {
                        if(os.length > 0) {
                            ...
                            message.callMessage(ms); //vào phần nhắn tin khi đăng ký thành công
                        }
                    }
