...
public class ViewImage extends javax.swing.JComponent {
    ...
    public void displayImage(Icon image) {
        this.image = image;
        pic.setImage(image);
        setVisible(true);
    }
    ...
    private void initComponents() {
        ...
        pic.getAccessibleContext().setAccessibleName("");
    ...
    private void cmdSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdSaveActionPerformed
        PublicEvent.getInstance().geEventImageView().saveImage(image);
    }//GEN-LAST:event_cmdSaveActionPerformed

    @Override
    protected void paintComponent(Graphics g) { // cho 1 ảnh nổi lên ghi đè
        Graphics2D g2 = (Graphics2D)g;
        g2.setColor(new Color(0, 0, 0, 150)); // đặt background ảnh nền màu đen
